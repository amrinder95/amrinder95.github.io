      ...
      <section className="min-h-screen">
        <nav className="py-10 mb-12 flex justify-between">
          ...
          <ul className="flex items-center">
            <li><a href="https://github.com/amrinder95/amrinder95.github.io/blob/main/Amrinder%20NEW%20resume.pdf" className="ml-8 rounded-md px-4 py-2 text-white bg-emerald-400 text-xl hover:bg-gray-600" target="_blank">Resume</a></li>
          </ul>
        </nav>
